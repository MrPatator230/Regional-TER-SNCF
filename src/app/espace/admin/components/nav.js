...
export default function Nav() {
  return (
    <div className="admin-nav-wrap">
      <wcs-nav className="admin-nav" aria-label="Main menu">
        ...
        <wcs-nav-item>
          <Link href="/espace/admin/afficheurs/interieurs">
            <wcs-mat-icon icon="tv"></wcs-mat-icon>
            <span>Afficheurs intérieurs</span>
          </Link>
        </wcs-nav-item>
